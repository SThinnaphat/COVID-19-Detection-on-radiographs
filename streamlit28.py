...
st.image("C:\\Users\\HP\\Documents\\GitHub\\FinalProj_ThinnaphatD\\FinalProj\\bg.jpg",width=700)
...
if uploaded_file is not None:
  ...
  if Generate_pred:
    ...
    st.title("Predicted label on image is {}".format(map_dict[prediction]))import cv2
import numpy as np
import streamlit as st
import tensorflow as tf
from tensorflow.keras.preprocessing import image
